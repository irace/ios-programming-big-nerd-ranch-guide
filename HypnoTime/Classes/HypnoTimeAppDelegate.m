...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    UIViewController *viewController1 = [[HypnosisViewController alloc] init];
    UIViewController *viewController2 = [[CurrentTimeViewController alloc] init];
	...
	// Put the tab bar controller's view on the window
